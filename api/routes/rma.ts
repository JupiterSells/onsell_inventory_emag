...
router.get('/', asyncHandler(async (req: Request, res: Response) => {
  ...
  if (req.query.product_id) filters.product_id = parseInt(req.query.product_id as string, 10);
  if (req.query.product_emag_id) filters.product_emag_id = parseInt(req.query.product_emag_id as string, 10);
